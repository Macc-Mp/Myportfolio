            ...
            <div className="container">
                <div className="top">
                    <div>
                        ...
                        <p className="subtitle">Participating in school events.</p>
                    </div>
        ...
        <div className="gallery">
          <div className="card">
            <a className="card-link" href="/participation/p2/day1.jpg" target="_blank" rel="noopener noreferrer">
              ...
              <div className="caption">Day 1 session</div>
            </a>
          </div>
          ...
          <div className="card">
            <a className="card-link" href="/participation/p2/day2.jpg" target="_blank" rel="noopener noreferrer">
              ...
              <div className="caption">Day 2 session</div>
            </a>
          </div>

          <div className="card">
            <a className="card-link" href="/participation/p2/day3.jpg" target="_blank" rel="noopener noreferrer">
              <img src="/participation/p2/day3.jpg" alt="Certificate thumbnail" />
              <div className="caption">Day 3 session</div>
            </a>
          </div>
